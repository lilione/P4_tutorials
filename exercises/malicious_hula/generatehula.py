...
def main():
    ...
    info = [
            ("10.0.1.0", "10.0.2.0", (2, 2, 1, 1), "s1-eth0"),
            ("10.0.1.0", "10.0.2.0", (3, 2, 1, 1), "s1-eth0"),
            ("10.0.1.0", "10.0.3.0", (2, 3, 1, 1), "s1-eth0"),
            ("10.0.1.0", "10.0.3.0", (3, 3, 1, 1), "s1-eth0"),
            ("10.0.2.0", "10.0.1.0", (2, 1, 2, 1), "s2-eth0"),
            ("10.0.2.0", "10.0.1.0", (3, 1, 2, 1), "s2-eth0"),
            ("10.0.2.0", "10.0.3.0", (2, 3, 2, 1), "s2-eth0"),
            ("10.0.2.0", "10.0.3.0", (3, 3, 2, 1), "s2-eth0"),
            ("10.0.3.0", "10.0.1.0", (2, 1, 3, 1), "s3-eth0"),
            ("10.0.3.0", "10.0.1.0", (3, 1, 3, 1), "s3-eth0"),
            ("10.0.3.0", "10.0.2.0", (2, 2, 3, 1), "s3-eth0"),
            ("10.0.3.0", "10.0.2.0", (3, 2, 3, 1), "s3-eth0")]
